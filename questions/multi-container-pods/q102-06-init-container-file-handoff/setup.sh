#!/usr/bin/env bash
# Idempotent: creates/resets namespace q102-06-init-container-file-handoff and seeds broken/partial resources.
# Every object created here - namespaced or cluster-scoped - MUST carry the
# label clusterdrill-question=q102-06-init-container-file-handoff. Never assume
