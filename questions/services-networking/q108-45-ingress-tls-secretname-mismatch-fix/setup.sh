...
# The Ingress's tls[].secretName deliberately points at a Secret that does
# not exist ("secure-app-tls-old") instead of the real one above.
kubectl apply -n "$QUESTION_ID" -f - <<EOF
